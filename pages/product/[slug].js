  ...
  return (
    <div className="px-5 pb-10 pt-6">
      <div className="flex items-center gap-3">
        <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-line bg-inkCard font-display text-xl">
          {product.name[0]}
        </div>
        <div>
      ...
      <div className="mt-6 grid grid-cols-3 gap-3 text-center">
        <div className="rounded-xl border border-line bg-inkCard py-3">
