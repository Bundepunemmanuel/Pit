      ...
      >
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="flex-1 rounded-lg border border-line px-3 py-2.5 text-sm outline-none placeholder:text-grayText"
          />
        </div>
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          ...
          <select
            ...
            className="rounded-lg border border-line px-3 py-2.5 text-sm text-grayText md:w-48"
          >
        ...
        <div>
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-line px-3 py-2.5 text-sm outline-none placeholder:text-grayText"
          />
